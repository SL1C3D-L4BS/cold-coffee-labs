...
GLOBAL_SUBS: list[tuple[str, str]] = [
    ...
    ("BLACKLAKE_FRAMEWORK_BLF-CCL-001-REV-A.md", "08_BLACKLAKE_AND_RIPPLE_STUDIO_SPECS.md"),
    ("GREYWATER_ENGINE_GWE-ARCH-001-REV-A_Ripple-IDE-Spec.md", "08_BLACKLAKE_AND_RIPPLE_STUDIO_SPECS.md"),
