...
REPLACEMENTS: list[tuple[str, str]] = [
    ...
    ("docs/BLACKLAKE_FRAMEWORK_BLF-CCL-001-REV-A.md", "docs/08_BLACKLAKE_AND_RIPPLE.md"),
    ("docs/GREYWATER_ENGINE_GWE-ARCH-001-REV-A_Ripple-IDE-Spec.md", "docs/08_BLACKLAKE_AND_RIPPLE.md"),
